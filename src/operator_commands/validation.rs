...
pub(crate) fn validated_terminal_read_artifacts(
    ...
    let selected_handoff = crate::engineer_handoff::select_handoff_artifact_for_read(
        state_root,
        crate::engineer_handoff::ScopedHandoffMode::Terminal,
        "terminal read",
    )?;
...
pub(crate) fn validated_engineer_read_artifacts(
    ...
    let selected_handoff = crate::engineer_handoff::select_handoff_artifact_for_read(
        state_root,
        crate::engineer_handoff::ScopedHandoffMode::Engineer,
        "engineer read",
    )?;
    Ok(EngineerReadArtifacts {
        handoff_path: selected_handoff.path,
