...
use crate::rpc::{
    RPC_ERROR_TIMEOUT, RPC_ERROR_TRANSPORT, RpcErrorPayload, RpcRequest, RpcResponse,
};
...
impl RpcTransport for SubprocessRpcTransport {
...
impl Drop for SubprocessRpcTransport {
    fn drop(&mut self) {
...
mod tests {
    use super::*;
    use crate::rpc::RPC_ERROR_TIMEOUT;
    ...
    fn read_response_returns_timeout_error_when_subprocess_is_silent() {
        ...
        // read_response should return a RpcResponse with RPC_ERROR_TIMEOUT.
        ...
        let result = SubprocessRpcTransport::read_response(
            &mut managed,
            "test-id-1",
        ...
        assert_eq!(
            ...
            "error code should be RPC_ERROR_TIMEOUT"
        );
        assert!(
