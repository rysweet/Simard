//! RPC client for cognitive memory operations.
//!
...
use crate::rpc::{RpcRequest, RpcTransport, new_request_id, unpack_rpc_response};
...
impl CognitiveMemoryClient {
    ...
    fn call<T: serde::de::DeserializeOwned>(
        ...
        unpack_rpc_response(CLIENT_NAME, method, response)
    }
...
impl CognitiveMemoryOps for CognitiveMemoryClient {
    fn record_sensory(
        &self,
        modality: &str,
        raw_data: &str,
        ...
        CognitiveMemoryClient::record_sensory(self, modality, raw_data, ttl_seconds)
    }

    fn prune_expired_sensory(&self) -> SimardResult<usize> {
        CognitiveMemoryClient::prune_expired_sensory(self)
    }
    ...
    fn push_working(
        ...
        CognitiveMemoryClient::push_working(self, slot_type, content, task_id, relevance)
    }

    fn get_working(&self, task_id: &str) -> SimardResult<Vec<CognitiveWorkingSlot>> {
        CognitiveMemoryClient::get_working(self, task_id)
    }

    fn clear_working(&self, task_id: &str) -> SimardResult<usize> {
        CognitiveMemoryClient::clear_working(self, task_id)
    }
    ...
    fn store_episode(
        ...
        CognitiveMemoryClient::store_episode(self, content, source_label, metadata)
    }

    fn consolidate_episodes(&self, batch_size: u32) -> SimardResult<Option<String>> {
        CognitiveMemoryClient::consolidate_episodes(self, batch_size)
    }
    ...
    fn store_fact(
        ...
        CognitiveMemoryClient::store_fact(self, concept, content, confidence, tags, source_id)
    }
    ...
    fn search_facts(
        ...
        CognitiveMemoryClient::search_facts(self, query, limit, min_confidence)
    }
    ...
    fn store_procedure(
        ...
        CognitiveMemoryClient::store_procedure(self, name, steps, prerequisites)
    }

    fn recall_procedure(&self, query: &str, limit: u32) -> SimardResult<Vec<CognitiveProcedure>> {
        CognitiveMemoryClient::recall_procedure(self, query, limit)
    }
    ...
    fn store_prospective(
        ...
        CognitiveMemoryClient::store_prospective(
            self,
            description,
            trigger_condition,
            action_on_trigger,
    ...
    fn check_triggers(&self, content: &str) -> SimardResult<Vec<CognitiveProspective>> {
        CognitiveMemoryClient::check_triggers(self, content)
    }

    fn get_statistics(&self) -> SimardResult<CognitiveStatistics> {
        CognitiveMemoryClient::get_statistics(self)
    }
    ...
    fn search_episodes_by_keywords(
        ...
        CognitiveMemoryClient::search_episodes_by_keywords(self, keywords, limit)
    }
}
