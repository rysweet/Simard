...
//! `SIMARD_MEMORY_SOCKET`, [`launch_writer_client`] must NOT connect
...
//! `launch_writer_client` / `open_reader_client` to call
...
use super::{MEMORY_SOCKET_ENV, launch_writer_client, open_reader_client};
...
fn launch_writer_client_with_tempdir_state_root_does_not_touch_home_simard() {
