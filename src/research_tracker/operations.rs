...
pub fn load_research_topics(adapter: &dyn CognitiveMemoryOps) -> SimardResult<Vec<ResearchTopic>> {
    let facts = adapter.search_facts("research:", 50, 0.0)?;
