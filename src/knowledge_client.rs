...
impl KnowledgeClient {
    ...
    pub fn query(
        ...
        unpack_rpc_response(CLIENT_NAME, "knowledge.query", response)
    }
    ...
    pub fn list_packs(&self) -> SimardResult<Vec<KnowledgePackInfo>> {
        ...
        let wrapper: ListPacksResponse =
            unpack_rpc_response(CLIENT_NAME, "knowledge.list_packs", response)?;
        Ok(wrapper.packs)
    }
    ...
    fn call(&self, method: &str, params: Value) -> SimardResult<crate::rpc::RpcResponse> {
...
mod tests {
    ...
    fn mock_transport() -> InMemoryRpcTransport {
        InMemoryRpcTransport::new("knowledge-test", |method, params| match method {
