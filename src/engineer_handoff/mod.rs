...
// Re-export all public items so `crate::engineer_handoff::X` still works.
pub use artifact::{
...
pub use types::{
    ...
    EngineerHandoffContext, SHARED_DEFAULT_STATE_ROOT_SOURCE, SHARED_EXPLICIT_STATE_ROOT_SOURCE,
    ScopedHandoffMode, SelectedHandoffArtifact, TERMINAL_HANDOFF_FILE_NAME, TERMINAL_MODE_BOUNDARY,
};
