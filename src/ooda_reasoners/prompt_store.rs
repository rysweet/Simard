...
//! ## Why
//!
//! The three prompt-driven brains (`RustyClawdActReasoner`, `RustyClawdDecideReasoner`,
//! `RustyClawdOrientReasoner` — PRs #1458, #1469, #1471, wired in #1474) embed
...
/// global store. Used by call sites that record a [`crate::ooda_reasoners::
/// judgment_record::ReasonerJudgmentRecord`] right after invoking a prompt-driven
