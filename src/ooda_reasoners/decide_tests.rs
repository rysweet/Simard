...
//! DeterministicFallbackDecideReasoner routing table.

use super::{DecideContext, DecideJudgment, DecideReasoner, DeterministicFallbackDecideReasoner};
...
// ---------------------------------------------------------------------------
// DeterministicFallbackDecideReasoner — preserves pre-#1458 mapping
// ---------------------------------------------------------------------------
