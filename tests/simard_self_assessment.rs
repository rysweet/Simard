    ...
    vec![
        Feature {
            ...
            evidence: vec![
                ...
                "src/terminal_engineer.rs — adapter between engineer loop and terminal",
            ...
            status: if module_exists(src, "terminal_session")
                && module_exists(src, "terminal_engineer")
            {
                Status::Implemented
            } else {
                Status::Missing
        ...
        Feature {
            ...
            evidence: vec![
                ...
                "src/memory_store_adapter.rs — hydrate_from_adapter() for cross-session recovery",
...
fn simard_feature_comparison_against_original_prompt() {
    ...
    println!("  seeding, memory persistence with adapter query + retry,");
