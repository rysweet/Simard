...
- **Captured:** `2026-05-25T07-35-35-834Z` (UTC)
...
- **Artifacts dir:** `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/`
...
| 7 | brain-failure surfacing tied to #1890 _(issue #1890 closed)_ | **PARTIAL** | API probes: /api/brain-failures→404, /api/failures→404<br>Panel header text mentions brain-failure indicator — see report screenshots<br>Cross-ref: issue #1890 is CLOSED; this dimension scores on dashboard surface, not on issue state. |
...
|---|---|---:|---|---:|---|
| `landing` | Landing (post-login) | 10 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/00-landing.png` |
| `overview` | Overview | 10 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/01-overview.png` |
| `goals` | Goals | 3 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/02-goals.png` |
| `traces` | Traces | 3 | 2026-05-25T07:33:39 | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/03-traces.png` |
| `logs` | Logs | 40 | 2026-05-25T07:33:39.829070383Z | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/04-logs.png` |
| `processes` | Processes | 3 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/05-processes.png` |
| `memory` | Memory | 6 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/06-memory.png` |
| `costs` | Costs | 4 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/07-costs.png` |
| `chat` | Chat | 2 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/08-chat.png` |
| `workboard` | Workboard | 11 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/09-workboard.png` |
| `thinking` | 🧠 Thinking | 2 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/10-thinking.png` |
| `terminal` | Terminal | 4 | — | 0 | `scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/11-terminal.png` |

## API probe summary

| Endpoint | Status | Bytes | Keys / preview | Linked dimensions |
|---|---:|---:|---|---|
| `/api/status` | 200 | 408 | active_processes, daemon_health, disk_usage_pct, git_hash, ooda_daemon, timestamp, version | ooda, memory |
| `/api/goals` | 200 | 4927 | active, active_count, backlog, backlog_count | goal-board |
| `/api/processes` | 200 | 66900 | count, processes, root_pid, timestamp | engineers |
| `/api/memory` | 200 | 859 | evidence_records, goal_records, handoff, last_consolidation, memory_records, native_memory, native_memory_db_exists, native_memory_db_path | memory |
| `/api/workboard` | 200 | 49176 | cognitive_statistics, cycle, goals, next_cycle_eta_seconds, recent_actions, spawned_engineers, task_memory, timestamp | goal-board, ooda, memory |
| `/api/traces` | 200 | 117207 | otel_enabled, otel_endpoint, span_count, spans, timestamp | ooda |
| `/api/logs` | 200 | 3541240 | cost_log_lines, cycle_reports, daemon_log_lines, ooda_transcripts, terminal_transcripts, timestamp | — |
...
- **P2** — _brain-failure surfacing tied to #1890_ — dashboard: deepen brain-failure surfacing tied to #1890 (currently point-in-time only / no history / no labels)
...
- ![Landing (post-login)](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/00-landing.png)
- ![Overview](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/01-overview.png)
- ![Goals](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/02-goals.png)
- ![Traces](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/03-traces.png)
- ![Logs](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/04-logs.png)
- ![Processes](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/05-processes.png)
- ![Memory](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/06-memory.png)
- ![Costs](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/07-costs.png)
- ![Chat](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/08-chat.png)
- ![Workboard](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/09-workboard.png)
- ![🧠 Thinking](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/10-thinking.png)
- ![Terminal](scripts/dashboard-audit/out/2026-05-25T07-35-35-834Z/11-terminal.png)
