...
- **Captured:** `2026-06-06T14-26-22-965Z` (UTC)
...
- **Artifacts dir:** `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/`
...
| 4 | cognitive memory growth | **PRESENT** | API /api/memory → 200 (keys: evidence_records, goal_records, handoff, last_consolidation, memory_records, native_memory, native_memory_db_exists, native_memory_db_path, native_memory_error, state_root, timestamp, total_facts); includes native_memory.episodic/semantic counts<br>API /api/memory/history → 200 (keys: deltas, rate_per_hour, sample_interval_seconds, schema_version, snapshot_count, snapshots, timestamp, trend); provides snapshots, deltas, rate_per_hour, trend<br>API /api/workboard → 200 also surfaces cognitive_statistics block (point-in-time snapshot only)<br>Tab .tab[data-tab="memory"] (#tab-memory) screenshot: 06-memory.png<br>Memory growth card detected in Memory tab |
...
- **cognitive memory growth** — Time-series history with per-snapshot deltas, growth rates, trend direction, and sparkline visualization are exposed via /api/memory/history and rendered in the Memory tab growth card.
...
|---|---|---:|---|---:|---|
| `landing` | Landing (post-login) | 10 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/00-landing.png` |
| `overview` | Overview | 12 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/01-overview.png` |
| `goals` | Goals | 3 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/02-goals.png` |
| `traces` | Traces | 3 | 2026-06-06T14:23:48 | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/03-traces.png` |
| `logs` | Logs | 40 | 2026-06-06T14:23:48.955569742Z | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/04-logs.png` |
| `processes` | Processes | 3 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/05-processes.png` |
| `memory` | Memory | 12 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/06-memory.png` |
| `costs` | Costs | 4 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/07-costs.png` |
| `chat` | Chat | 2 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/08-chat.png` |
| `workboard` | Workboard | 11 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/09-workboard.png` |
| `thinking` | 🧠 Thinking | 3 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/10-thinking.png` |
| `brain-failures` | Brain Failures | 3 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/11-brain-failures.png` |
| `merge-decisions` | Merge Decisions | 2 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/12-merge-decisions.png` |
| `pr-readiness` | PR Readiness | 2 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/13-pr-readiness.png` |
| `terminal` | Terminal | 4 | — | 0 | `scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/14-terminal.png` |
...
| `/api/goals` | 200 | 5373 | active, active_count, backlog, backlog_count | goal-board |
| `/api/processes` | 200 | 18960 | count, processes, root_pid, timestamp | engineers |
| `/api/memory` | 200 | 858 | evidence_records, goal_records, handoff, last_consolidation, memory_records, native_memory, native_memory_db_exists, native_memory_db_path | memory |
| `/api/memory/history` | 200 | 1079 | deltas, rate_per_hour, sample_interval_seconds, schema_version, snapshot_count, snapshots, timestamp, trend | memory |
| `/api/workboard` | 200 | 53814 | cognitive_statistics, cycle, goals, next_cycle_eta_seconds, recent_actions, spawned_engineers, task_memory, timestamp | goal-board, ooda, memory |
| `/api/traces` | 200 | 120931 | otel_enabled, otel_endpoint, span_count, spans, timestamp | ooda |
| `/api/logs` | 200 | 2879163 | cost_log_lines, cycle_reports, daemon_log_lines, ooda_transcripts, terminal_transcripts, timestamp | — |
| `/api/costs` | 200 | 311 | daily, weekly | — |
| `/api/merge-judge` | 200 | 445 | decisions, persistence_available, persistence_reason, summary, timestamp | merge-judge |
| `/api/prs` | 200 | 1558 | prs, summary, timestamp | per-pr |
...
- ![Landing (post-login)](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/00-landing.png)
- ![Overview](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/01-overview.png)
- ![Goals](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/02-goals.png)
- ![Traces](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/03-traces.png)
- ![Logs](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/04-logs.png)
- ![Processes](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/05-processes.png)
- ![Memory](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/06-memory.png)
- ![Costs](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/07-costs.png)
- ![Chat](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/08-chat.png)
- ![Workboard](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/09-workboard.png)
- ![🧠 Thinking](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/10-thinking.png)
- ![Brain Failures](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/11-brain-failures.png)
- ![Merge Decisions](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/12-merge-decisions.png)
- ![PR Readiness](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/13-pr-readiness.png)
- ![Terminal](scripts/dashboard-audit/out/2026-06-06T14-26-22-965Z/14-terminal.png)

## Self-introspection vs. human-operator verdict

Of the seven mandated dimensions: **7 PRESENT**, **0 PARTIAL**, **0 MISSING**.
