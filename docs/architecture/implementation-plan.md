...
|-------|------------|-------------|--------|
| 0 | Bridge infrastructure | `bridge`, `server_circuit`, `server_subprocess`, `server_launcher` | Merged |
| 1 | Cognitive memory via amplihack-memory-lib | `memory_adapter`, `memory_store_adapter`, `memory_cognitive`, `memory_consolidation`, `memory_hive` | Merged |
