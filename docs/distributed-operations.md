...
> The bus is **in-process only**. It does not cross process or machine boundaries. A future workstream may add a network adapter that clients this bus to a remote transport; nothing in this module assumes one.
