...
- [Cognitive memory bridge helpers](./reference/cognitive-memory-adapter-helpers.md) - `launch_writer_adapter` / `open_reader_adapter` resolution ladder; design notes for the planned in-process Arc shortcut and strict no-silent-degradation contract (issue #1590 follow-up).
